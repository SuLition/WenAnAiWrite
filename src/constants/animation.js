...
export const ANIMATION_SPEED_MODES = {
  disabled: { value: 0.01, label: '禁用动画', description: '几乎无动画' },
  fast: { value: 0.7, label: '快速', description: '高效流畅' },
  normal: { value: 1.0, label: '标准', description: '推荐' },
  elegant: { value: 1.3, label: '优雅', description: '视觉享受' }
}
